...
| :--- | :---------- | :------ |
| `BulkSynchronize<T>(items)` | Bulk synchronize entities in your database. | [Try it in EF6](https://dotnetfiddle.net/rYYc4V) | [Try it in EF Core](https://dotnetfiddle.net/JVsPRj) |
| `BulkSynchronize<T>(items, options)` | Bulk synchronize entities in your database.  | [Try it in EF6](https://dotnetfiddle.net/D1GBYP) | [Try it in EF Core](https://dotnetfiddle.net/JAmTXP)|
